    ...
    render() {
        ...
        return (
            <div style={{position:'absolute',top:0}}>
                <div className="stage" style={{background:'#000',opacity:0.5}}/>
                <div style={{position:'absolute',top:0}}>
                    <div className="stage" style={{textAlign:'center'}}>
                        <div className="sdkSelector" style={{display:'inline-block',verticalAlign: 'middle'}}>
                            <div style={{height:50}}>
                                <div style={{marginLeft:-82}}>{tr(55)}</div>
                                <LocationSelector inputValue={this.state.ruffSDKLocation} placeholder={tr(10)}
                                                  onChangeValue={(value)=>{self.getSDKPath(value)}}/>
                                <div style={{marginLeft:-69}}>{this.state.info}</div>
                            </div>
                        </div>
                    </div>
                </div>
